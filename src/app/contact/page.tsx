            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:info@tegequipment.com"
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-1">Canada</p>
                </div>
              </div>
            </div>
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                >
                  ...
                  <option value="lab-parts">Lab Parts &amp; Supplies</option>
                  <option value="utilities-machinery">Utilities Machinery</option>
              ...
              <button
                type="submit"
                className="w-full bg-accent hover:bg-red-700 text-white font-semibold py-3 rounded-md transition-colors"
              >
                Send Message
              </button>
            </form>
